...
def get_options(args=None):
    ...
    # Datadevice_num
    parser.add_argument('--problem', default='hcvrp', help="The problem to solve, default 'hcvrp'")
    parser.add_argument('--graph_size', type=int, default=60, help="The size of the problem graph")
    parser.add_argument('--pomo_size', type=int, default=8, help="The size of the problem graph")
    parser.add_argument('--batch_size', type=int, default=256, help='Number of instances per batch during training')  # 512
    parser.add_argument('--epoch_size', type=int, default=25600, help='Number of instances per epoch during training')  # 1280000
    ...
    parser.add_argument('--lr_decay', type=float, default=0.975, help='Learning rate decay per epoch')
    ...
    parser.add_argument('--agent_list', default=[3], help="Number of M in evaluation")
    parser.add_argument('--depot_eval', default=1, help="Number of D in evaluation")
    parser.add_argument('--r_eval', type=int, default=256, help="Number of permutations in evaluation")
